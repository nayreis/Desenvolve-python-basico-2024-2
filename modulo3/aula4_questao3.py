...
# Escreva um código em Python que solicita ao usuário para 
# inserir um ano e imprime "Bissexto" se o ano for 
# (1) divisível por 
# 4 e não for divisível por 100, ou (2) se for divisível por 400. 
